...
public class TDBTDPileGeneration {
   /* public static void generatePileRibs() {
    ...
    public static void generatePileTeeth() {
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.DEEP_DARK),
                GenerationStep.Feature.UNDERGROUND_DECORATION, TDBTDPlacedFeatures.PILE_SCULK_TEETH.getKey().get());
    }
    public static void generatePileSmallFern() {
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.DEEP_DARK),
