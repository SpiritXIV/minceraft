...
public class ScutleonEntity extends HostileEntity {
    ...
    public ScutleonEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return HostileEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, 12.00)
    ...
    @Override
    protected SoundEvent getDeathSound() {return SoundEvents.BLOCK_SCULK_SHRIEKER_BREAK;}
