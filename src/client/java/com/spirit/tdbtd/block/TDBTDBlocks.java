...
public class TDBTDBlocks {
    ...
    public static final Block INFURTRINATED_DEEPSLATE_ORE = new Block(FabricBlockSettings.copy(Blocks.STONE).sounds(BlockSoundGroup.DEEPSLATE).requiresTool());
    public static final Block CRITERIC_CHARRED_PLANKS = new Block(FabricBlockSettings.copy(Blocks.STONE).sounds(BlockSoundGroup.BASALT));
  ...
  //public static final Block DIMENTED_DIRT_PATH = registerBlock("dimented_dirt_path", new TDBTDDirtPathBlock(FabricBlockSettings.copy(Blocks.DIRT_PATH).sounds(BlockSoundGroup.ROOTED_DIRT).strength(2.0F).requiresTool().ticksRandomly()));
    ...
    public static final Block INFURTRINATED_STONE_SLAB = new Block(FabricBlockSettings.copy(Blocks.STONE).sounds(BlockSoundGroup.SCULK_CATALYST).strength(2.0F).requiresTool());
    ...
    public static final Block SCULK_WEED = new TDBTDSmallPlantBlock(FabricBlockSettings.copy(Blocks.SCULK).sounds(BlockSoundGroup.SCULK_CATALYST).nonOpaque().strength(2.0F).requiresTool(), () -> Blocks.SCULK);
