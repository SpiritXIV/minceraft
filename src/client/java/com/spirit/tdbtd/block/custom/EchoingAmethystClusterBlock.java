...
public class EchoingAmethystClusterBlock extends EchoingAmethystBlock implements Waterloggable {
	...
	public EchoingAmethystClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
		super(settings);
