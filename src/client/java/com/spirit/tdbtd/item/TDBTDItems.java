...
import static com.spirit.tdbtd.TDBTDHelperMethods.*;
...
public class TDBTDItems {
    ...
    public static final Item DIMENTED_SWORD = new SwordItem(TDBTDToolMaterial.INSTANCE, 9, -0F, new FabricItemSettings().rarity(Rarity.RARE));
    public static final Item DIMENTED_PICKAXE = new TDBTDPickaxeItem(TDBTDToolMaterial.INSTANCE, 8, -2.8F, new FabricItemSettings().rarity(Rarity.RARE));
    public static final Item DIMENTED_AXE = new TDBTDAxeItem(TDBTDToolMaterial.INSTANCE, 11, -3.2F, new FabricItemSettings().rarity(Rarity.RARE));
    ...
    public static final Item DIMENTED_HOE = new TDBTDHoeItem(TDBTDToolMaterial.INSTANCE, 2, -3.2F, new FabricItemSettings().rarity(Rarity.RARE));
