...
public class CuratorEntity extends HostileEntity implements Angerable {
    ...
    public CuratorEntity(EntityType<CuratorEntity> entityType, World world) {
    ...
    public CuratorEntity(EntityType<CuratorEntity> entityType, World world, EntityGameEventHandler<Vibrations.VibrationListener> gameEventHandler) {
        super(entityType, world);
    }
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(3, new UniversalAngerGoal<CuratorEntity>(this, true));
    ...
    private void angerNearbyCurator() {
        ...
        this.getWorld().getEntitiesByClass(CuratorEntity.class, box, EntityPredicates.EXCEPT_SPECTATOR).stream().filter(curator -> curator != this).filter(curator -> curator.getTarget() == null).filter(curator -> !curator.isTeammate(this.getTarget())).forEach(curator -> curator.setTarget(this.getTarget()));
    }
