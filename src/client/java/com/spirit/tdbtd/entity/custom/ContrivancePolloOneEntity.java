...
public class ContrivancePolloOneEntity extends HostileEntity {
    ...
    public ContrivancePolloOneEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    protected SoundEvent getDeathSound() {
        this.playSound(SoundEvents.BLOCK_AMETHYST_BLOCK_BREAK, 20.0f, 0f);
