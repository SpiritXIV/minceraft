...
import com.spirit.tdbtd.entity.custom.PericarpiumEntity;
...
public class PericarpiumRenderer extends MobEntityRenderer<PericarpiumEntity, PericarpiumModel<PericarpiumEntity>> {
    private static final Identifier TEXTURE = new Identifier(Main.SHIT_ID, "textures/entity/pericarpium.png");
