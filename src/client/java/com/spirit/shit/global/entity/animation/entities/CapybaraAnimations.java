...
public class CapybaraAnimations {
    ...
    public static void FileContents() {
        Animation capybaraIdle = CapybaraAnimations.CAPYBARA_IDLE;
        Animation capybaraWalk = CapybaraAnimations.CAPYBARA_WALK;

}
    public static final Animation CAPYBARA_IDLE = Animation.Builder.create(4f).looping()
    ...
    public static final Animation CAPYBARA_WALK = Animation.Builder.create(1f).looping()
