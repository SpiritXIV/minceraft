package com.spirit.shit.global.particle.custom;
...
public class PlayerEntityParticle extends SpriteBillboardParticle {
    ...
    private static final Identifier TEXTURE = new Identifier(Main.SHIT_ID, "textures/particle/schizo/player.png");
    ...
    public PlayerEntityParticle(ClientWorld clientWorld, double x, double y, double z) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new PlayerEntityParticle(clientWorld, x, y, z);
        }
    }
}
