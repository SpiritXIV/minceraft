...
public class ShitBlocks {
    ...
    public static final Block KINGZHARA_PLUSH = registerBlock("kingzhara_plush",
            new KingZharaPlushBlock(FabricBlockSettings.copy(Blocks.BLACK_CONCRETE).sounds(BlockSoundGroup.STONE).strength(2.0F)));
