...
public class PlayerEntityParticle extends SpriteBillboardParticle {
    ...
    PlayerEntityParticle(ClientWorld clientWorld, double x, double y, double z, SpriteProvider spriteSet, double xx, double yy, double zz) {
        super(clientWorld, x, y, z);
        this.model = new ZombieEntityModel<ZombieEntity>(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EntityModelLayers.ZOMBIE));
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld clientWorld, double x, double y, double z, double xx, double yy, double zz) {
            return new PlayerEntityParticle(clientWorld, x, y, z, this.sprites, xx, yy, zz);
        }
    }
}