...
public class ShizeBlushingRoseCanProjectileItem extends Item {
    public ShizeBlushingRoseCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeBlushingRoseCanProjectileEntity snowballEntity = new ShizeBlushingRoseCanProjectileEntity(world, user);
