...
public class RumBottleProjectileItem extends Item {
    public RumBottleProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            RumBottleProjectileEntity snowballEntity = new RumBottleProjectileEntity(world, user);
