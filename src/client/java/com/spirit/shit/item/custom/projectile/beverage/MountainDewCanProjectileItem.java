...
public class MountainDewCanProjectileItem extends Item {
    public MountainDewCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            MountainDewCanProjectileEntity snowballEntity = new MountainDewCanProjectileEntity(world, user);
