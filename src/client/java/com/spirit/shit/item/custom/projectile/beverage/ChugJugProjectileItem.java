...
public class ChugJugProjectileItem extends Item {
    public ChugJugProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ChugJugProjectileEntity snowballEntity = new ChugJugProjectileEntity(world, user);
