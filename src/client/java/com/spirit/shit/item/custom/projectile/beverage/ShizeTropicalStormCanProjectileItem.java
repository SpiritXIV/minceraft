...
public class ShizeTropicalStormCanProjectileItem extends Item {
    public ShizeTropicalStormCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeTropicalStormCanProjectileEntity snowballEntity = new ShizeTropicalStormCanProjectileEntity(world, user);
