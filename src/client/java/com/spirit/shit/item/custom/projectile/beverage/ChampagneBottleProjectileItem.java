...
public class ChampagneBottleProjectileItem extends Item {
    public ChampagneBottleProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ChampagneBottleProjectileEntity snowballEntity = new ChampagneBottleProjectileEntity(world, user);
