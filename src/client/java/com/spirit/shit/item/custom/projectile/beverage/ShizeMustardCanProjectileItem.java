...
public class ShizeMustardCanProjectileItem extends Item {
    public ShizeMustardCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeMustardCanProjectileEntity snowballEntity = new ShizeMustardCanProjectileEntity(world, user);
