...
public class CocaColaCanProjectileItem extends Item {
    public CocaColaCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            CocaColaCanProjectileEntity snowballEntity = new CocaColaCanProjectileEntity(world, user);
