...
public class ShizePineapplePizzaCanProjectileItem extends Item {
    public ShizePineapplePizzaCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizePineapplePizzaCanProjectileEntity snowballEntity = new ShizePineapplePizzaCanProjectileEntity(world, user);
