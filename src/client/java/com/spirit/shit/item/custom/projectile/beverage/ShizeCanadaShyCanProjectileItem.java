...
public class ShizeCanadaShyCanProjectileItem extends Item {
    public ShizeCanadaShyCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeCanadaShyCanProjectileEntity snowballEntity = new ShizeCanadaShyCanProjectileEntity(world, user);
