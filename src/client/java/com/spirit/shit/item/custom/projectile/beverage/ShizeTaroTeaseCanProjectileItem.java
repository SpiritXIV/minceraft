...
public class ShizeTaroTeaseCanProjectileItem extends Item {
    public ShizeTaroTeaseCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeTaroTeaseCanProjectileEntity snowballEntity = new ShizeTaroTeaseCanProjectileEntity(world, user);
