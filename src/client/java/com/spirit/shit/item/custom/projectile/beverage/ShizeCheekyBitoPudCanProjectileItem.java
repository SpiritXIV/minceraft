...
public class ShizeCheekyBitoPudCanProjectileItem extends Item {
    public ShizeCheekyBitoPudCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeCheekyBitoPudCanProjectileEntity snowballEntity = new ShizeCheekyBitoPudCanProjectileEntity(world, user);
