...
public class ShizeTiramisuCanProjectileItem extends Item {
    public ShizeTiramisuCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeTiramisuCanProjectileEntity snowballEntity = new ShizeTiramisuCanProjectileEntity(world, user);
