...
public class ShizeLemonPartyCanProjectileItem extends Item {
    public ShizeLemonPartyCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeLemonPartyCanProjectileEntity snowballEntity = new ShizeLemonPartyCanProjectileEntity(world, user);
