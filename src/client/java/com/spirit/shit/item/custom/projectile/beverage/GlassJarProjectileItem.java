...
public class GlassJarProjectileItem extends Item {
    public GlassJarProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            GlassJarProjectileEntity snowballEntity = new GlassJarProjectileEntity(world, user);
