...
public class ShizeFrenchVanillaCanProjectileItem extends Item {
    public ShizeFrenchVanillaCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeFrenchVanillaCanProjectileEntity snowballEntity = new ShizeFrenchVanillaCanProjectileEntity(world, user);
