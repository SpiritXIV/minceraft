...
public class ShizeStrawberryKiwiCanProjectileItem extends Item {
    public ShizeStrawberryKiwiCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeStrawberryKiwiCanProjectileEntity snowballEntity = new ShizeStrawberryKiwiCanProjectileEntity(world, user);
