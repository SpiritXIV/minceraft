...
public class MugRootBeerCanProjectileItem extends Item {
    public MugRootBeerCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            MugRootBeerCanProjectileEntity snowballEntity = new MugRootBeerCanProjectileEntity(world, user);
