...
public class ShizeFulmedamesCanProjectileItem extends Item {
    public ShizeFulmedamesCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeFulmedamesCanProjectileEntity snowballEntity = new ShizeFulmedamesCanProjectileEntity(world, user);
