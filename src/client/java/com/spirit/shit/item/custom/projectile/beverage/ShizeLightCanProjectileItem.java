...
public class ShizeLightCanProjectileItem extends Item {
    public ShizeLightCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeLightCanProjectileEntity snowballEntity = new ShizeLightCanProjectileEntity(world, user);
