...
public class ShizeLiquorLisiousCanProjectileItem extends Item {
    public ShizeLiquorLisiousCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeLiquorLisiousCanProjectileEntity snowballEntity = new ShizeLiquorLisiousCanProjectileEntity(world, user);
