...
public class ShizeMayonnaiseCanProjectileItem extends Item {
    public ShizeMayonnaiseCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeMayonnaiseCanProjectileEntity snowballEntity = new ShizeMayonnaiseCanProjectileEntity(world, user);
