...
public class BonkAtomicPunchProjectileItem extends Item {
    public BonkAtomicPunchProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            BonkAtomicPunchProjectileEntity snowballEntity = new BonkAtomicPunchProjectileEntity(world, user);
