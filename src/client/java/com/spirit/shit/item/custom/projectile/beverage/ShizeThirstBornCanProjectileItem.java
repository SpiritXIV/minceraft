...
public class ShizeThirstBornCanProjectileItem extends Item {
    public ShizeThirstBornCanProjectileItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShizeThirstBornCanProjectileEntity snowballEntity = new ShizeThirstBornCanProjectileEntity(world, user);
