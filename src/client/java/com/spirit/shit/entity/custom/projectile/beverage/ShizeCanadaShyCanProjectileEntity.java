...
public class ShizeCanadaShyCanProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.SHIZE_CANADASHY_CAN;
    }

    public ShizeCanadaShyCanProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.ShizeCanadaShyCanProjectileEntityType, owner, world);
    }

    public ShizeCanadaShyCanProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.ShizeCanadaShyCanProjectileEntityType, x, y, z, world);
    }
