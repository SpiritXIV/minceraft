...
public class ShizeCheekyBitoPudCanProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.SHIZE_CHEEKYBITOPUD_CAN;
    }

    public ShizeCheekyBitoPudCanProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.ShizeCheekyBitoPudCanProjectileEntityType, owner, world);
    }

    public ShizeCheekyBitoPudCanProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.ShizeCheekyBitoPudCanProjectileEntityType, x, y, z, world);
    }
