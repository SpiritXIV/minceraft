...
public class YippeeEntity extends HostileEntity implements GeoEntity {
    ...
    public YippeeEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> event) {
        ...
        event.getController().setAnimation(RawAnimation.begin().then("animation.yippee.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }
