...
public class DartMonkeyEntity extends HostileEntity implements GeoEntity {
    ...
    public DartMonkeyEntity(EntityType<? extends HostileEntity> entityType, World world) {
