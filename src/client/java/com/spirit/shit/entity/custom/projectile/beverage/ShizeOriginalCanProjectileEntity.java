...
public class ShizeOriginalCanProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.SHIZE_ORIGINAL_CAN;
    }

    public ShizeOriginalCanProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.ShizeOriginalCanProjectileEntityType, owner, world);
    }

    public ShizeOriginalCanProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.ShizeOriginalCanProjectileEntityType, x, y, z, world);
    }
