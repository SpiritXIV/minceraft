...
public class ShizeJellyBeanCanProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.SHIZE_JELLYBEAN_CAN;
    }

    public ShizeJellyBeanCanProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.ShizeJellyBeanCanProjectileEntityType, owner, world);
    }

    public ShizeJellyBeanCanProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.ShizeJellyBeanCanProjectileEntityType, x, y, z, world);
    }
