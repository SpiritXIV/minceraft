...
public class SlugProjectileEntity extends ThrownItemEntity {
    public SlugProjectileEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ShitItems.SLUG_ENTITY;
    }

    public SlugProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.SlugProjectileEntityType, owner, world);
    }

    public SlugProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.SlugProjectileEntityType, x, y, z, world);
    }
