...
public class ShizePineapplePizzaCanProjectileEntity extends BeverageProjectileEntity {
    static EntityType TYPE = ShitMod.ShizePineapplePizzaCanProjectileEntityType;
