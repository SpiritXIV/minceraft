...
public class MugProjectileEntity extends ThrownItemEntity {
    ...
    public MugProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.MugProjectileEntityType, owner, world);
    }

    public MugProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.MugProjectileEntityType, x, y, z, world);
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            livingEntity.damage(new DamageSource(RegistryEntry.of(new DamageType("got_mugged", 1))), 2);
        }
    }
