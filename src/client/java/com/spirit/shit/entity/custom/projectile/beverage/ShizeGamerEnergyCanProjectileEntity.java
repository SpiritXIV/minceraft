...
public class ShizeGamerEnergyCanProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.SHIZE_GAMERENERGY_CAN;
    }

    public ShizeGamerEnergyCanProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.ShizeGamerEnergyCanProjectileEntityType, owner, world);
    }

    public ShizeGamerEnergyCanProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.ShizeGamerEnergyCanProjectileEntityType, x, y, z, world);
    }
