...
public class ShizeJuicyMelonCanProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.SHIZE_JUICYMELON_CAN;
    }

    public ShizeJuicyMelonCanProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.ShizeJuicyMelonCanProjectileEntityType, owner, world);
    }

    public ShizeJuicyMelonCanProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.ShizeJuicyMelonCanProjectileEntityType, x, y, z, world);
    }
