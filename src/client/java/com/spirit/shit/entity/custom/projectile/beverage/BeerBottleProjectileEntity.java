...
public class BeerBottleProjectileEntity extends ThrownItemEntity {
    ...
    protected Item getDefaultItem() {
        return ShitItems.BEER_BOTTLE;
    }

    public BeerBottleProjectileEntity(World world, LivingEntity owner) {
        super(ShitMod.BeerBottleProjectileEntityType, owner, world);
    }

    public BeerBottleProjectileEntity(World world, double x, double y, double z) {
        super(ShitMod.BeerBottleProjectileEntityType, x, y, z, world);
    }
