...
public class RepositoryLogger {
    ...
    public static void logInitializedClasses(Class<?>[] initializedClasses) {
        ...
        try {
            ...
            ShitMod.LOGGER.info(">> | Preparing loading classes in background...");
            ShitMod.LOGGER.info(">> | Beginning loading classes in background...");
            ...
            ShitMod.LOGGER.info(">> | Finished loading classes files");
