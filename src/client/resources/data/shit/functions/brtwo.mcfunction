...
execute as @a[nbt={Dimension:"shit:backroomstwo"},gamemode=!spectator] at @s if block ~ ~ ~ shit:backrooms_wallpaper_lip run tp @s ~4 ~ ~
...
execute as @e[type=marker,tag=flicker2_r] at @s if block ~ ~ ~ light[level=15] in shit:backroomstwo run playsound shit:light_flicker master @a[nbt={Dimension:"shit:backroomstwo"}] ~ ~ ~ 0.2 0.8
execute as @e[type=marker,tag=flicker2_r] at @s anchored eyes if block ~ ~ ~ light[level=15] in shit:backroomstwo run particle minecraft:flame ^ ^1 ^ 0 0 0 0.1 2 force @a
execute as @e[type=marker,tag=flicker2_r] at @s anchored eyes if block ~ ~ ~ light[level=15] in shit:backroomstwo run particle minecraft:ash ^ ^1 ^ 0 0 0 2 10 force @a
