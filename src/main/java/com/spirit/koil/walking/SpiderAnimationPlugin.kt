...
import com.spirit.koil.api.bukkit.event.block.Action
import com.spirit.koil.api.bukkit.plugin.Plugin
import com.spirit.koil.api.bukkit.plugin.java.JavaPlugin
import com.spirit.koil.walking.StayStillBehaviour.equals
...
class SpiderAnimationPlugin : JavaPlugin() {
    override fun onEnable() {
        ...
        server.pluginManager.registerEvents(object : com.spirit.koil.api.bukkit.event.Listener {
            @com.spirit.koil.api.bukkit.event.EventHandler
            fun onEntitySpawn(event: com.spirit.koil.api.bukkit.event.entity.EntitySpawnEvent) {
        ...
        server.pluginManager.registerEvents(object : com.spirit.koil.api.bukkit.event.Listener {
            @com.spirit.koil.api.bukkit.event.EventHandler
            fun onPlayerInteract(event: com.spirit.koil.api.bukkit.event.player.PlayerInteractEvent) {
                ...
                when (event.item?.type) {
                    ...
                    Material.NETHERITE_INGOT -> {
                        ...
                        if (spiderVal == null) {
                            ...
                            event.player.sendMessage("Spider created")
                        } else {
                            ...
                            spider = null
                            event.player.sendMessage("Spider removed")
                        }
                    }
