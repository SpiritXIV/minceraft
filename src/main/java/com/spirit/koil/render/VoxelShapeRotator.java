...
public class VoxelShapeRotator {
    ...
    public static Map<Direction, VoxelShape> rotateAllDirections(VoxelShape originalShape) {
        ...
        rotatedShapes.put(Direction.SOUTH, originalShape);
        rotatedShapes.put(Direction.WEST, rotate90Degrees(originalShape));
        rotatedShapes.put(Direction.NORTH, rotate180Degrees(originalShape));
        rotatedShapes.put(Direction.EAST, rotate270Degrees(originalShape));
