...
import com.spirit.koil.api.bukkit.map.MapCursor;
 ...
 * {@link com.spirit.koil.api.bukkit.generator.structure.Structure} or
 * {@link com.spirit.koil.api.bukkit.generator.structure.StructureType} instead.
 */
...
public final class StructureType implements Keyed {
     ...
     * @param mapIcon the {@link com.spirit.koil.api.bukkit.map.MapCursor.Type} this structure type should use
    ...
    /**
     * Get the {@link com.spirit.koil.api.bukkit.map.MapCursor.Type} that this structure can use on maps. If
     * this is null, this structure will not appear on explorer maps.
     *
     * @return the {@link com.spirit.koil.api.bukkit.map.MapCursor.Type} or null.
     */
    @Nullable
