...
import com.spirit.koil.api.bukkit.command.TabCompleter;
import com.spirit.koil.api.bukkit.permissions.Permissible;
import com.spirit.koil.api.bukkit.permissions.Permission;
...
public final class PluginDescriptionFile {
     ...
     *     itself.
     * <li>If your namespace is <code>com.spirit.koil.api.bukkit.plugin</code>, and your class
     *     file is called <code>MyPlugin</code> then this must be
     *     <code>com.spirit.koil.api.bukkit.plugin.MyPlugin</code>
     * <li>No plugin can use <code>com.spirit.koil.api.bukkit.</code> as a base package for
     ...
     * <p>
     * Example:
     * <blockquote><pre>main: com.spirit.koil.api.bukkit.plugin.MyPlugin</pre></blockquote>
     *
    ...
    private void loadMap(@NotNull Map<?, ?> map) throws InvalidDescriptionException {
        ...
        try {
            ...
            if (main.startsWith("com.spirit.koil.api.bukkit.")) {
                throw new InvalidDescriptionException("main may not be within the com.spirit.koil.api.bukkit namespace");
            }
        } catch (NullPointerException ex) {
