...
import com.spirit.koil.api.bukkit.help.HelpTopic;
import com.spirit.koil.api.bukkit.help.HelpTopicComparator;
import com.spirit.koil.api.bukkit.help.IndexHelpTopic;
import com.spirit.koil.api.bukkit.util.ChatPaginator;
...
public class HelpCommand extends BukkitCommand {
    ...
    public static class BukkitHelpCommand {
        public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
            dispatcher.register(CommandManager.literal("help")
                    .executes(BukkitHelpCommand::executeBukkitHelp)
            );
        }

        private static int executeBukkitHelp(CommandContext<ServerCommandSource> context) {
            @NotNull String[] args = new String[0];
            ...
            if (topic == null || !topic.canSee((CommandSender) context.getSource())) {
                context.getSource().sendMessage(Text.of(ChatColor.RED + "No help for " + command));
                return 1;
            }

            ChatPaginator.ChatPage page = ChatPaginator.paginate(topic.getFullText((CommandSender) context.getSource()), pageNumber, pageWidth, pageHeight);
            ...
            context.getSource().sendMessage(Text.of(header.toString()));

            //context.getSource().sendMessage(page.getLines());
