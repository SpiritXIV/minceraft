package com.spirit.koil.api.bukkit.metadata;
...
public abstract class MetadataStoreBase<T> {
     ...
     *     com.spirit.koil.api.bukkit.plugin.Plugin)
     */
     ...
     * @throws IllegalArgumentException If plugin is null
     * @see MetadataStore#invalidateAll(com.spirit.koil.api.bukkit.plugin.Plugin)
     */
