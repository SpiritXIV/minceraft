...
public class ShizeLiquorLisiousCanProjectileEntity extends BeverageProjectileEntity {
    static EntityType TYPE = ShitMod.ShizeLiquorLisiousCanProjectileEntityType;
