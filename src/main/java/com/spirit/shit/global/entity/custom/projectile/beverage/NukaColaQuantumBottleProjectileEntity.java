...
public class NukaColaQuantumBottleProjectileEntity extends BeverageProjectileEntity {
    static EntityType TYPE = ShitMod.NukaColaQuantumBottleProjectileEntityType;
