...
public class ShitItems {
    ...
    public static final Item BBQ_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item BIG_BITES = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item BLUE_HEAT_TAKI_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item CHOCO_CRUNCH = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item DIVINE_BLISS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item FISHERMEN = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item FLAVOR_WAVE = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item FUEGO_TAKI_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item LUCKY_SEVENS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item MEAT_TORNADO = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item MIRACLE_MAKER = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item NACHO_DORITOS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item NACHO_TAKI_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item NAN_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item NITRO_TAKI_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item NY_CRISPIES = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item PLAIN_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item POLISHED_CRISPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item POPEM = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item RANCH_DORITOS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item SALTY_OASIS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item SOUR_CREAM_ONION_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item SPUD_LITE = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item STOKED_SMOKED = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item USA_OVEN_BAKED = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item YUMYUM = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
    public static final Item ZOMBIE_TAKI_CHIPS = new ChipsBagItem(new FabricItemSettings().maxCount(64).rarity(Rarity.COMMON));
