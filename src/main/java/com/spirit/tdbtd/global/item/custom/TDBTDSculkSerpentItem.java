...
public class TDBTDSculkSerpentItem extends RangedWeaponItem implements Vanishable {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld) {
            if (user.isSneaking()) {
                ...
                world.playSoundFromEntity(null, user, TDBTDSounds.DIMENTED_SERPENT_CHARGE, SoundCategory.PLAYERS, 1,1);
    ...
    public static void executeSonicBoom(World world, PlayerEntity user, float damage) {
        if (world instanceof ServerWorld serverWorld) {
            ...
            world.playSoundFromEntity(null, user, TDBTDSounds.DIMENTED_SERPENT_SHOOT, SoundCategory.PLAYERS, 1,1);
