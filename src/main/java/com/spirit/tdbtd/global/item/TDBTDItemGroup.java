...
public class TDBTDItemGroup {
    public static final ItemGroup TDBTD_ITEM_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier(Main.TDBTD_ID, "tdbtd_group"),
            FabricItemGroup.builder()
                    .displayName(Text.literal("The Depths Below The Deep"))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(TDBTDBlocks.INFURTRINATED_STONE_STAIRS);
                        entries.add(TDBTDBlocks.INFURTRINATED_STONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_STONE_PRESSURE_PLATE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_STONE_BUTTON);
                        ...
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_COBBLESTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_COBBLESTONE_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_COBBLESTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_COBBLESTONE_WALL);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_STONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_STONE_SLAB);
                        ...
                        //entries.add(TDBTDBlocks.CHISELED_INFURTRINATED_STONE_BRICKS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_STONE_BRICKS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_STONE_BRICKS_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_STONE_BRICKS_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_MOSSY_STONE_BRICKS_WALL);
                        entries.add(TDBTDBlocks.INFURTRINATED_GRANITE);
                        entries.add(TDBTDBlocks.INFURTRINATED_GRANITE_STAIRS);
                        entries.add(TDBTDBlocks.INFURTRINATED_GRANITE_SLAB);
                        entries.add(TDBTDBlocks.INFURTRINATED_GRANITE_WALL);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_GRANITE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_GRANITE_STAIRS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_GRANITE_SLAB);
                        entries.add(TDBTDBlocks.INFURTRINATED_DIORITE);
                        entries.add(TDBTDBlocks.INFURTRINATED_DIORITE_STAIRS);
                        entries.add(TDBTDBlocks.INFURTRINATED_DIORITE_SLAB);
                        entries.add(TDBTDBlocks.INFURTRINATED_DIORITE_WALL);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DIORITE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DIORITE_STAIRS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DIORITE_SLAB);
                        entries.add(TDBTDBlocks.INFURTRINATED_ANDESITE);
                        entries.add(TDBTDBlocks.INFURTRINATED_ANDESITE_STAIRS);
                        entries.add(TDBTDBlocks.INFURTRINATED_ANDESITE_SLAB);
                        entries.add(TDBTDBlocks.INFURTRINATED_ANDESITE_WALL);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_ANDESITE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_ANDESITE_STAIRS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_ANDESITE_SLAB);
                        ...
                        //entries.add(TDBTDBlocks.CHISELED_INFURTRINATED_DEEPSLATE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DEEPSLATE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DEEPSLATE_STAIRS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DEEPSLATE_SLAB);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_DEEPSLATE_WALL);
                        ...
                        //entries.add(TDBTDBlocks.REINFORCED_INFURTRINATED_DEEPSLATE_TILES_WALL);
                        //entries.add(TDBTDBlocks.DIMENTED_PACKED_MUD);
                        //entries.add(TDBTDBlocks.DIMENTED_MUD_BRICKS);
                        //entries.add(TDBTDBlocks.DIMENTED_MUD_BRICKS_STAIRS);
                        //entries.add(TDBTDBlocks.DIMENTED_MUD_BRICKS_SLAB);
                        //entries.add(TDBTDBlocks.DIMENTED_MUD_BRICKS_WALL);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SANDSTONE_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SANDSTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SANDSTONE_WALL);
                        //entries.add(TDBTDBlocks.CHISELED_INFURTRINATED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_SANDSTONE_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_SANDSTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_SANDSTONE_WALL);
                        //entries.add(TDBTDBlocks.INFURTRINATED_CUT_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_CUT_SANDSTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_RED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_RED_SANDSTONE_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_RED_SANDSTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_RED_SANDSTONE_WALL);
                        //entries.add(TDBTDBlocks.CHISELED_INFURTRINATED_RED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_RED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_RED_SANDSTONE_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_RED_SANDSTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_RED_SANDSTONE_WALL);
                        //entries.add(TDBTDBlocks.INFURTRINATED_CUT_RED_SANDSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_CUT_RED_SANDSTONE_SLAB);
                        //Most nether items are simply too hot for the sculk to embed in.
                        entries.add(TDBTDBlocks.INFURTRINATED_BASALT);
                        entries.add(TDBTDBlocks.INFURTRINATED_SMOOTH_BASALT);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BASALT);
                        entries.add(TDBTDBlocks.INFURTRINATED_BLACKSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_GILDED_BLACKSTONE);
                        //entries.add(TDBTDBlocks.INFURTRINATED_BLACKSTONE_STAIRS);
                        //entries.add(TDBTDBlocks.INFURTRINATED_BLACKSTONE_SLAB);
                        //entries.add(TDBTDBlocks.INFURTRINATED_BLACKSTONE_WALL);
                        //entries.add(TDBTDBlocks.CHISELED_POLISHED_INFURTRINATED_BLACKSTONE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_STAIRS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_SLAB);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_WALL);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_PRESSURE_PLATE);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_BUTTON);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_BRICKS);
                        //entries.add(TDBTDBlocks.CRACKED_POLISHED_INFURTRINATED_BLACKSTONE_BRICKS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_BRICKS_STAIRS);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_BRICKS_SLAB);
                        //entries.add(TDBTDBlocks.POLISHED_INFURTRINATED_BLACKSTONE_BRICKS_WALL);
                        //Most end items are simply too cold for the sculk to embed in.
                        ...
                        //entries.add(TDBTDBlocks.DIMENTED_MYCELIUM);
                        //entries.add(TDBTDBlocks.DIMENTED_DIRT_PATH);
                        ...
                        //entries.add(TDBTDBlocks.DIMENTED_MUD);
                        //entries.add(TDBTDBlocks.DIMENTED_CLAY);
                        entries.add(TDBTDBlocks.DIMENTED_GRAVEL);
                        entries.add(TDBTDBlocks.DIMENTED_SAND);
                        //entries.add(TDBTDBlocks.DIMENTED_RED_SAND);
                        ...
                        //entries.add(TDBTDBlocks.INFURTRINATED_DRIPSTONE);
