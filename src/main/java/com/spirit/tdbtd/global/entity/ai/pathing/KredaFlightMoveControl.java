package com.spirit.tdbtd.global.entity.ai.pathing;
...
public class KredaFlightMoveControl extends MoveControl {
    private final int maxPitchChange;
    private final boolean noGravity;

    public KredaFlightMoveControl(MobEntity entity, int maxPitchChange, boolean noGravity) {
        super(entity);
